...
export default function Footer() {
  return (
    <footer className="bg-brand-dark text-brand-light border-t border-white/10">
      <div className="max-w-6xl mx-auto px-6 py-16 w-full grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
        <div className="flex flex-col h-full justify-between gap-6 md:gap-12">
